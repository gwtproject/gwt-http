 ...
 * 
 * <p>
 * Most applications will be interested in the {@link org.gwtproject.http.client.Request}, {@link org.gwtproject.http.client.RequestBuilder}, 
 * {@link org.gwtproject.http.client.RequestCallback} and {@link org.gwtproject.http.client.Response} classes.
 * </p>
 * 
 * <h2>Caveats</h2>
 ...
 * this, you can always set timeouts for the request via {@link org.gwtproject.http.client.RequestBuilder#setTimeoutMillis(int)}.
 * 
 * <h3>Required Module</h3>
 * Modules that use the classes and interfaces in this package should inherit
 * the <code>org.gwtproject.http.HTTP</code> module.
 * 
 * {@gwt.include com/google/gwt/examples/http/InheritsExample.gwt.xml}
 *  
 * <h2>Quick Howto's</h2>
 * <h3>How should I write a RequestCallback handler class?</h3>
 * The following code shows how a {@link org.gwtproject.http.client.RequestCallback} instance should be written.
 ...
 * 
 * <h3>How can I make a {@link org.gwtproject.http.client.RequestBuilder} send a request other than GET or POST?</h3>
