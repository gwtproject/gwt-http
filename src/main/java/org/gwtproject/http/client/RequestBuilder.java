...
public class RequestBuilder {
   ...
   *          {@link org.gwtproject.http.client.URL#encode(String)},
   *          {@link org.gwtproject.http.client.URL#encodePathSegment(String)} and
   *          {@link org.gwtproject.http.client.URL#encodeQueryString(String)} for
   *          how to do this.
   ...
   *          {@link org.gwtproject.http.client.URL#encode(String)} and
   *          {@link org.gwtproject.http.client.URL#encodePathSegment(String)} and
   *          {@link org.gwtproject.http.client.URL#encodeQueryString(String)} for
   *          how to do this.
   * @throws IllegalArgumentException if the httpMethod or URL are empty
   ...
   * {@link org.gwtproject.http.client.RequestCallback#onError(Request, Throwable)}
   * method will be called on the callback instance given to the
   * {@link org.gwtproject.http.client.RequestBuilder#sendRequest(String, RequestCallback)}
   * method. The callback method will receive an instance of the
   * {@link org.gwtproject.http.client.RequestTimeoutException} class as its
