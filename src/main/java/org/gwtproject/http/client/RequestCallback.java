 ...
 * org.gwtproject.http.client.Request}.
 */
public interface RequestCallback {

  /**
   * Called when a pending {@link org.gwtproject.http.client.Request} completes normally. Note this
   ...
   * @param response an instance of the {@link org.gwtproject.http.client.Response} class
   */
  void onResponseReceived(Request request, Response response);

  /**
   * Called when a {@link org.gwtproject.http.client.Request} does not complete normally. A {@link
   * org.gwtproject.http.client.RequestTimeoutException RequestTimeoutException} is one example of
