...
public interface RequestCallback {
  ...
  /**
   * Called when a pending {@link org.gwtproject.http.client.Request} completes
   ...
   *        {@link org.gwtproject.http.client.Response} class 
   */
  void onResponseReceived(Request request, Response response);

  /**
   * Called when a {@link org.gwtproject.http.client.Request} does not complete
   * normally.  A {@link org.gwtproject.http.client.RequestTimeoutException RequestTimeoutException} is
